...
export const MERCHANT_SIDEBAR: SidebarConfig = {
  ...
  roleLabel: "Merchant",
  items: [
    { href: "/merchant", label: "Overview", icon: LayoutDashboard, exact: true },
...
export const WAREHOUSE_SIDEBAR: SidebarConfig = {
  ...
  roleLabel: "Warehouse",
  items: [
    { href: "/warehouse", label: "Intake queue", icon: PackagePlus, exact: true },
    { href: "/warehouse/dispatch", label: "Dispatch desk", icon: Truck, exact: true },
    { href: "/warehouse/exceptions", label: "Exceptions", icon: AlertTriangle, exact: true },
    { href: "/warehouse/reconciliation", label: "COD reconciliation", icon: Wallet, exact: true },
  ],
}
...
export const RIDER_SIDEBAR: SidebarConfig = {
  ...
  items: [
    ...
    { href: "/rider/deliveries", label: "Delivery queue", icon: Truck, exact: true },
  ],
}
